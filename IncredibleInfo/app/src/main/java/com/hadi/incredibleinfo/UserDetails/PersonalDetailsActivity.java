...
import com.hadi.incredibleinfo.UserDetails.ProfessionalDetailsActivity;
...
public class PersonalDetailsActivity extends AppCompatActivity {
    ...
    private String name,mobile,location,links,skills,email;
    private int userId;

    private EditText nameEditText,mobileEditText,locationEditText,linksEditText,skillsEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameEditText = findViewById(R.id.organization_edit_text);
